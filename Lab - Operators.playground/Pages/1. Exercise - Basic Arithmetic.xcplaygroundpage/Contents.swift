...
//func add(widh:Int,height:Int){
//    let perimeter = widh + widh + height + height
//    print(perimeter)
//}
...
// The difference is converting the product of an integer number into a decimal number
/*:
