...
//It differs because the integer number carries only one digit, while the decimal number carries two digits and is more accurate than the integer
...
let  percentOfGoal = 10_000 / 3.467
